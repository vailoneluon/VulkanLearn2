	...
	m_VulkanHandles(vulkanHandles), m_SwapchainHandles(swapchainHandles), m_msaaSamples(msaaSamples)
{
	...
	CreateBlurHRenderPass();
	CreateBlurVRenderPass();
}
...
VulkanRenderPass::~VulkanRenderPass()
{
	...
	vkDestroyRenderPass(m_VulkanHandles.device, m_Handles.blurHRenderPass, nullptr);
	vkDestroyRenderPass(m_VulkanHandles.device, m_Handles.blurVRenderPass, nullptr);
}
...
void VulkanRenderPass::CreateBlurHRenderPass()
{
	VkAttachmentDescription colorAttachment{};
	colorAttachment.format = m_SwapchainHandles.swapchainSupportDetails.chosenFormat.format;
	colorAttachment.samples = VK_SAMPLE_COUNT_1_BIT;
	...
	VK_CHECK(vkCreateRenderPass(m_VulkanHandles.device, &renderPassInfo, nullptr, &m_Handles.blurHRenderPass), "LỖI: Tạo render pass thất bại!");
}

void VulkanRenderPass::CreateBlurVRenderPass()
{
	VkAttachmentDescription colorAttachment{};
	colorAttachment.format = m_SwapchainHandles.swapchainSupportDetails.chosenFormat.format;
	colorAttachment.samples = VK_SAMPLE_COUNT_1_BIT;
	...
	VK_CHECK(vkCreateRenderPass(m_VulkanHandles.device, &renderPassInfo, nullptr, &m_Handles.blurVRenderPass), "LỖI: Tạo render pass thất bại!");
}
