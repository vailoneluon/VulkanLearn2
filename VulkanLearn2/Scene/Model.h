...
// =================================================================================================
// Struct: MeshRange
// Mô tả: Xác định một khoảng (range) trong vertex buffer và index buffer chung
...
// =================================================================================================
// Struct: Mesh
// Mô tả: Đại diện cho một mesh con trong một model.
...
// =================================================================================================
// Struct: ModelHandles
// Mô tả: Struct chứa dữ liệu nội bộ của một Model.
// =================================================================================================
struct ModelHandles
{
...
// Class: Model
// Mô tả: 
//      Đại diện cho một đối tượng 3D có thể render, bao gồm một hoặc nhiều mesh.
...
public:
	...
	// Getter: Lấy danh sách các mesh con của model.
